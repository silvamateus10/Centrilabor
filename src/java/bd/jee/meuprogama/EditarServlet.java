...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        a.setIdaparelho(Integer.parseInt(request.getParameter("idaparelho")));
        a.setNome(request.getParameter("nome"));
        a.setMarca(request.getParameter("marca"));
        a.setDescricao(request.getParameter("descricao"));
        a.setPrecoDeCompra(Double.parseDouble(request.getParameter("precoDeCompra")));
        a.setPrecoDeVenda(Double.parseDouble(request.getParameter("precoDeVenda")));
